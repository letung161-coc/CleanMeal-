// ============================================================
//  foodDatabase.js – Database sản phẩm thức ăn sạch CleanMeal
//  Bao gồm: thông tin món, macros dinh dưỡng, cách làm
// ============================================================
...
export const dishes = [
    {
        ...
        description: "Salad ức gà bụi bặm – giàu protein – ít chất béo, rất thích hợp cho người giảm cân, ăn kiêng, tập gym. Thịt gà mềm, rau tươi giòn kết hợp với sốt mè rang béo nhẹ, thơm ngậy tạo cảm giác ngon miệng mà không ngán.",
    ...
    },
    {
        ...
        description: "Món ăn sáng đơn giản – nhanh gọn – đầy đủ dinh dưỡng. Bơ béo tự nhiên kết hợp với trứng ốp la thơm mềm và bánh mì đen cung cấp năng lượng lâu dài, không gây tăng cân.",
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1505252585461-04db1eb84625?auto=format&fit=crop&w=600&q=80",
        description: "Sinh tố giàu protein sau tập gym, kết hợp chuối ngọt tự nhiên, sữa hạmann nhân và protein powder.",
...
// ============================================================
//  Tập hợp categories đầy đủ
// ============================================================
export const categories = [
    { id: 1, name: "Chicken", slug: "chicken" },
    { id: 2, name: "Low Carb", slug: "low-carb" },
    { id: 3, name: "Breakfast", slug: "breakfast" },
    { id: 4, name: "Protein", slug: "protein-powder" },
    { id: 5, name: "Meal Prep", slug: "meal-prep" },
    { id: 6, name: "Salad", slug: "salad" },
    { id: 7, name: "Sandwiches", slug: "sandwiches" },
    { id: 8, name: "Snacks", slug: "snacks" },
    { id: 9, name: "Seafood", slug: "seafood" },
    { id: 10, name: "Vegetarian", slug: "vegetarian" },
    { id: 11, name: "Soup", slug: "soup" },
    { id: 12, name: "Drinks", slug: "drinks" },
];

// ============================================================
//  Helper – lọc theo category
// ============================================================
export function getDishesByCategory(slug) {
    if (!slug || slug === "all") return dishes;
